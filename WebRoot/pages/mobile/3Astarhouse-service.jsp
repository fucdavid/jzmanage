		...
		<div class="hk-main">
			...
			<div class="slider" id="slider" style="visibility: visible;">
				<ul class="swipe-wrap" style="height: 235px">
					<li><img src="common/images/star-1.png" style="height:260px;">
					</li>
				</ul>
			</div>
...
<%--						<div>--%>
<%--							<p>--%>
<%--								已经有<span class="orange">151665</span>人评价此服务--%>
<%--							</p>--%>
<%--							<p>--%>
...
<%--						</div>--%>
<%--					</li>--%>
<%--					<li onclick="showComment(72)" class="rt"><i class="icon arrow"></i></li>--%>
<%--				</ul>--%>
<%--				</section>--%>
			...
			<ul class="b">
				<li><label class="detail_item_title" data-id="3180">星级家 - 套餐<i class="icon arrow active"></i></label>
					<div class="detail_item_content" style="display: block;">
						<p>
							<img src="common/images/star-2.png" alt=""> 
						</p>
						<p>
							<img src="common/images/star-3.png" alt=""> 
						</p></div>
				</li>
