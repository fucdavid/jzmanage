package com.guoxin.common.constants;
 ...
 * @author PSY
 * @date 2015-3-16 下午05:16:55
 */
public class WxBaseURLs {

	public static String NOTIFY_URL = Constants.BASEROOT + "msgin-msgIn.gxad";

	/**
	 * 基础接口
	 */
	// 获取Access_token的URL(GET请求)
	public static String GET_ACCESS_TOKEN = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="
	 ...
	 */
	// 获取用户基本信息
	public static String GET_FANSINFO = "https://api.weixin.qq.com/cgi-bin/user/info?access_token="
			+ WxBase.getAccessToken() + "&lang=zh_CN&openid=";
	// 获取用户列表
	public static String GET_FANSLIST = "https://api.weixin.qq.com/cgi-bin/user/get?access_token="
			+ WxBase.getAccessToken() + "&next_openid";
	// 设置备注名
	...
	public static String DKF_UPDATE = "https://api.weixin.qq.com/customservice/kfaccount/update?access_token="
			+ WxBase.getAccessToken();
	// 删除客服信息
	public static String DKF_DELETE = "https://api.weixin.qq.com/customservice/kfaccount/del?access_token="
			+ WxBase.getAccessToken() + "&kf_account=";
	// 创建会话--绑定粉丝和客服
	...
	public static String DKF_CLOSESESSION = "https://api.weixin.qq.com/customservice/kfsession/close?access_token="
			+ WxBase.getAccessToken();
	// 获取客户的会话状态
	public static String DKF_SESSTION_STATUS = "https://api.weixin.qq.com/customservice/kfsession/getsession?access_token="
			+ WxBase.getAccessToken() + "&openid=";
	// 获取客服的会话列表
	public static String DKF_SESSION_LIST = "https://api.weixin.qq.com/customservice/kfsession/getsessionlist?access_token="
			+ WxBase.getAccessToken() + "&kf_account=";
	// 获取暂未接入的会话列表
	...
	public static String GET_AUTH_ACCESSCODE = "https://api.weixin.qq.com/sns/oauth2/access_token?appid="
			+ Constants.APPID
			+ "&secret="
			+ Constants.APPSECRET
	...
	public static String getAuth2AccessToken(String code) {
		/** 格式化正确url **/
		return MessageFormat.format(GET_AUTH_ACCESSCODE, code);
	}

	// 刷新OAuth2.0网页授权登录 接口凭证
	public static String GET_AUTH_REFRESHACCESSCODE = "https://api.weixin.qq.com/sns/oauth2/refresh_token?appid="
			+ Constants.APPID + "&grant_type=refresh_token&refresh_token={0}";
	...
	public static String GET_APITICKET = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token="
			+ WxBase.getAccessToken() + "&type=jsapi";
	// 获取jssdk中调用添加卡券接口的时候使用的ticket
	public static String GET_WXCARD_APITICKET = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token="
			+ WxBase.getAccessToken() + "&type=wx_card";
	...
	public static String UPLOAD_NEWS = "http://api.weixin.qq.com/cgi-bin/media/uploadnews?access_token="
			+ WxBase.getAccessToken();
	// 下载多媒体文件
	public static String DOWNLOAD_MEDIA = "http://file.api.weixin.qq.com/cgi-bin/media/get?access_token="
			+ WxBase.getAccessToken() + "&media_id=";
	// 新增临时素材
	public static String MATERIAL_TEMP_UPLOAD = "http://api.weixin.qq.com/cgi-bin/media/upload?access_token="
			+ WxBase.getAccessToken() + "&type=";
	// 获取临时素材
	public static String MATERIAL_TEMP_GET = "http://api.weixin.qq.com/cgi-bin/media/get?access_token="
			+ WxBase.getAccessToken() + "&media_id=";
	// 新增永久图文素材
